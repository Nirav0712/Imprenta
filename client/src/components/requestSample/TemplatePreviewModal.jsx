import { FiX, FiHeart, FiStar, FiCheck } from "react-icons/fi";
...
"
          ...
          <div className="p-8 lg:p-10 overflow-y-auto max-h-[90vh]">
            ...
            <span className="inline-flex rounded-full border border-sky-400/20 bg-sky-500/10 px-4 py-2 text-sm font-medium text-sky-300">
            ...
            <div className="mt-10">
              ...
              <div className="mt-4 flex gap-4">
                ...
                <button className="h-10 w-10 rounded-full bg-black ring-2 ring-sky-400"></button>

                <button className="h-10 w-10 rounded-full bg-blue-600"></button>

                <button className="h-10 w-10 rounded-full bg-red-500"></button>

                <button className="h-10 w-10 rounded-full bg-green-500"></button>

                <button className="h-10 w-10 rounded-full bg-yellow-400"></button>
